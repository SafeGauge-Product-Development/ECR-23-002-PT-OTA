...
void setupADS1120(void)
{
   ...
   shootSoftSpiData8(0b00000110);

   for (d = 0 ; d < 500 ; d++)
   {
   }

   shootSoftSpiData8(0b01000000 | 0b00000011);
   shootSoftSpiData8(0b00111010);
   shootSoftSpiData8(0b00000000);
   shootSoftSpiData8(0b10001000);
   shootSoftSpiData8(0b00000000);
...
void readAllADS1120configRegisters(void)
{
   ...
   shootSoftSpiData8(0b00100000 | 0b00000011);
...
void ledColour(unsigned char colour)
{
   ...
   if ((colour & 0b00000001) == 0b00000001)
      LATBbits.LATB1 = 1;
   else
      LATBbits.LATB1 = 0;

   if ((colour & 0b00000010) == 0b00000010)
      LATBbits.LATB2 = 1;
   else
      LATBbits.LATB2 = 0;

   if ((colour & 0b00000100) == 0b00000100)
      LATBbits.LATB3 = 1;
   else
      LATBbits.LATB3 = 0;
...
void XReceiveBTMessage (uint8 BTdata)
{
    ...
    static struct ble_header BTHeader;
