...
void ledRotate(void)
{
   ...
   switch(rotate)
   {
      ...
      case 5: LED_AQUA; break;
      case 6: LED_PURPLE; break;
...
void initialiseUart2(void)
{
   ...
   U2MODEbits.BRGH = 1;
   //U2BRG = 68;
//   U2BRG = 416;    //9600 baud @ 32MHz clock frequency
   U2BRG = 832;    //4800 baud @ 32MHz clock frequency
   //U2BRG = 1664;   //2400 baud @ 32MHz clock frequency
   //U2BRG = 208;      //19200 baud @ 32MHz clock frequency
